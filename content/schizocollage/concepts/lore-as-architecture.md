...
For practitioners working under post-authorship (see [[network-spirituality|Network Spirituality]]), the lore-as-architecture principle compounds: each new work adds a layer to the stack that the next work will inherit. The Crucifella becomes available to *Drifella III*; *Drifella* becomes available to [Drilady](drilady); Drilady completes the @dril-fella crossover that the scene's naming convention had been gesturing at since 2022. The myth-stack grows because each piece adds to it; the architecture compounds because each artist builds on what the prior artists left standing.

For the reader new to the scene, the consequence is that the wiki has to do real work. The figure pages, the [[lineage|Lineage]] page, and the [[critical-disputes|Critical Disputes]] page exist to make the lore architecturally legible — to give a curious viewer enough of the myth-stack to read a Drifella as the painting it is, rather than as the chaos it appears to be at glance.

## See also

- [[network-spirituality|Network Spirituality]] — the post-authorship condition that allows the myth-stack to grow
- [[drifella-iii|Drifella III]] — the canonical case where the architecture is most visible
- [[mifella|Mifella]] — the founding death-and-resurrection myth in the lore-stack
- [[evil-biscuit|Evil Biscuit]] — the artist treating lore as the design brief
- [[lineage|Lineage]] — where the inherited references come from
